...
const branches = [
  {
    ...
    phone: "+91 814 874 8140 / +91 814 814 8140",
  ...
  },
  {
    name: "Sivaganga",
    tag: "Branch Office",
    address: "Collector Office Road, Kanjarangal, Sivaganga",
    phone: "+91 814 874 8140",
    hours: "Monday to Sunday - 9 AM - 8 PM",
    mapUrl: "https://maps.google.com/?q=Sivaganga,Tamil+Nadu",
  },
  {
    name: "Dubai",
...
export default function BranchesSection() {
  return (
    <section id="branches" className="py-16 md:py-24 bg-[#1195db]">
      <div className="container-custom">
        {/* Header */}
        <ScrollReveal>
          <div className="text-center max-w-2xl mx-auto mb-12 md:mb-16">
            <span className="inline-flex items-center gap-2 bg-white/20 text-white rounded-full px-4 py-1.5 text-sm font-medium mb-4">
              <Navigation size={14} />
              Our Presence
            </span>
