...
export default function TopHeader() {
  ...
  const address = "Karaikudi, Tamil Nadu, India";
    ...
    <div className="bg-[#0E6FA3] text-white hidden md:block">
      <div className="container-custom py-2 px-4 flex items-center justify-between gap-3 text-xs sm:text-sm">
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          <a href={facebook} target="_blank" rel="noreferrer" aria-label="Facebook" className="hover:opacity-80 transition-opacity">
          ...
          <a href={instagram} target="_blank" rel="noreferrer" aria-label="Instagram" className="hover:opacity-80 transition-opacity">
          ...
          <a href={youtube} target="_blank" rel="noreferrer" aria-label="YouTube" className="hover:opacity-80 transition-opacity">
