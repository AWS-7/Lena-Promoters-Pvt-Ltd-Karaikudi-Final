...
export default function TopHeader() {
  ...
  const address = CONTACT.shortAddress;
  const facebook = settings?.facebook || CONTACT.facebook;
  const instagram = settings?.instagram || CONTACT.instagram;
  const youtube = settings?.youtube || CONTACT.youtube;
  const twitter = CONTACT.twitter;
  const linkedin = CONTACT.linkedin;

  return (
    <div className="bg-[#0E6FA3] text-white hidden md:block fixed top-0 left-0 right-0 z-[110]">
      <div className="container-custom py-2 px-4 flex items-center justify-between gap-3 text-xs sm:text-sm">
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          <a href={facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:opacity-80 transition-opacity">
          ...
          <a href={instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:opacity-80 transition-opacity">
          ...
          <a href={youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="hover:opacity-80 transition-opacity">
          ...
          <a href={twitter} target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="hover:opacity-80 transition-opacity">
          ...
          <a href={linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:opacity-80 transition-opacity">
